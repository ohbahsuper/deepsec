...
>
> DeepSec doit être utilisé uniquement sur des systèmes, domaines et applications que vous possédez ou pour lesquels vous disposez d’une autorisation explicite.
